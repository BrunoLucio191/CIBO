...
W=1080; BAND_H=420; BAND_Y=int(os.environ.get("BAND_Y",810))   # band top in the 1920-tall frame (env-overridable)
CY=int(os.environ.get("CAP_CY",1020))-BAND_Y   # caption center inside band
FPS=30
